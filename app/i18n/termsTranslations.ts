...
export const termsTranslations: Record<'zh-TW' | 'en', TermsTranslations> = {
  'zh-TW': {
    ...
    qrCodeNote: '確認課程時段並接受條款後，你將透過 WhatsApp 收到 QR 碼。',
  ...
  en: {
    ...
    qrCodeNote: 'After confirming your class session and accepting the terms, you will receive a QR code via a WhatsApp message.',
